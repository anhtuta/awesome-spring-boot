INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('1', 'Tiểu thuyết');
INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('2', 'Manga');
INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('3', 'Sách tham khảo');
INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('4', 'Kinh tế học');
INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('5', 'Kỹ năng sống');
INSERT INTO `springboot_tech`.`category` (`id`, `name`) VALUES ('6', 'Triết học');
